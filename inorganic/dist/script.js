...
theme?.addEventListener('click',()=>{root.classList.toggle('light');localStorage.setItem('inorganic-theme',root.classList.contains('light')?'light':'dark')});
